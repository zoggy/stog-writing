...
let fun_prepare_notes data env args subs =
  ...
  | Xtmpl.E (tag, atts, subs) ->
      ...
      | ("", "note") ->
          ...
          Xtmpl.E (("","sup"), Xtmpl.one_att ("", "id") [Xtmpl.D source],
           [
             Xtmpl.E (("", "a"), Xtmpl.one_att ("", "href") [Xtmpl.D ("#"^target)],
  ...
  let xml_of_note (n, xml) =
    ...
    Xtmpl.E (("", "div"),
     ...
     (Xtmpl.E (("", "sup"), Xtmpl.empty_atts, 
       [Xtmpl.E (("", "a"), 
          Xtmpl.one_att ("", "href") [Xtmpl.D ("#"^source)],
  ...
  let xml =
    Xtmpl.E (("", "div"), 
     Xtmpl.one_att ("", "class") [Xtmpl.D "notes"], 
     List.rev_map xml_of_note !notes)
  in
  let atts = Xtmpl.one_att ("", "notes") [ xml ] in
...
let fun_p tag elt (stog, data) env atts subs =
  let (id, atts) =
    ...
    | None ->
        ...
        (id, Xtmpl.one_att ~atts ("", "id") [Xtmpl.D id])
  in
  let set =
